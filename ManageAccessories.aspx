<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageAccessories.aspx.cs" Inherits="Pets_Heaven_.ManageAccessories" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Manage Accessories - Pets Heaven Admin</title>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
        <div class="navbar">
            ...
            <div class="nav-links" id="navLinks">
                ...
                <a href="ManageAccessories.aspx" class="active">🦴 Accessories</a>
        ...
        <div class="container">
            ...
            <a class="btn-add" href="Insert_Products.aspx?cat=2">+ Add New Accessory</a>

            <asp:GridView ID="gvAccessories" runat="server" AutoGenerateColumns="False" CssClass="grid"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Image">
                        <ItemTemplate>
                            <img src='<%# ResolveUrl(Convert.ToString(Eval("ImageURL"))) %>' alt="Accessory" />
                        </ItemTemplate>
                        <EditItemTemplate>
