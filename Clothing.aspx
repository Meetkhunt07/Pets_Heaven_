<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Clothing.aspx.cs" Inherits="Pets_Heaven_.Clothing" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Clothing - Pets Heaven</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="navbar">
            ...
            <div class="links" id="navLinks">
                ...
                <a href="Clothing.aspx" class="active">👕 Clothing</a>
        ...
        <!-- PAGE TITLE -->
        <h2 class="main-title">Pet Clothing Collection</h2>

        <!-- SEARCH BAR -->
        <div class="search-bar">
            <asp:TextBox ID="txtSearch" runat="server" CssClass="search-box" placeholder="Search clothing..." />
            <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn-buy" OnClick="btnSearch_Click" />
        </div>

        <!-- CLOTHING PRODUCT CARDS -->
        <div class="card-container">
            <asp:Repeater ID="rptClothing" runat="server">
                <ItemTemplate>
                    <div class="card">
                        <img src='<%# ResolveUrl(Eval("ImageURL").ToString()) %>' alt="Clothing" />
