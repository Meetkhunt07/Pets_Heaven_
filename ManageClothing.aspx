<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageClothing.aspx.cs" Inherits="Pets_Heaven_.ManageClothing" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Manage Clothing - Pets Heaven Admin</title>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <div class="navbar">
            ...
            <div class="nav-links" id="navLinks">
                ...
                <a href="ManageClothing.aspx" class="active">👕 Clothing</a>
        ...
        <div class="container">
            ...
            <a class="btn-add" href="Insert_Products.aspx?cat=3">+ Add New Clothing</a>

            <!-- 📋 GridView -->
            <asp:GridView ID="gvClothing" runat="server" AutoGenerateColumns="False" CssClass="grid"
                OnRowEditing="gvClothing_RowEditing"
                OnRowUpdating="gvClothing_RowUpdating"
                OnRowCancelingEdit="gvClothing_RowCancelingEdit"
                OnRowDeleting="gvClothing_RowDeleting"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Image">
                        <ItemTemplate>
                            <img src='<%# ResolveUrl(Convert.ToString(Eval("ImageURL"))) %>' alt="Clothing" />
                        </ItemTemplate>
                        <EditItemTemplate>
