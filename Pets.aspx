<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pets.aspx.cs" Inherits="Pets_Heaven.Pets" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Available Pets - Pets Heaven</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="navbar">
            ...
            <div class="links" id="navLinks">
                ...
                <a href="Pets.aspx" class="active">🐶 Pets</a>
        ...
        <div class="main-container">
            <h2 class="main-title">Available Pets</h2>

            <!-- SEARCH BAR -->
            <div class="search-bar">
                <asp:TextBox ID="txtSearch" runat="server" CssClass="search-box" placeholder="Search for a pet..." />
            ...
            <div class="card-container">
                <asp:Repeater ID="rptPets" runat="server">
                    <ItemTemplate>
                        <div class="card">
                            <img src='<%# ResolveUrl(Eval("ImageURL").ToString()) %>' alt='<%# Eval("ProductName") %>' />
