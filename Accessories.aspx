<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Accessories.aspx.cs" Inherits="Pets_Heaven_.Accessories" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Accessories - Pets Heaven</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="navbar">
            ...
            <div class="links" id="navLinks">
                ...
                <a href="Accessories.aspx" class="active">🦴 Accessories</a>
        ...
        <!-- TITLE -->
        <h2 class="main-title">Accessories for Your Pet</h2>

        <!-- SEARCH BAR -->
        <div class="search-bar">
            <asp:TextBox ID="txtSearch" runat="server" CssClass="search-box" placeholder="Search accessories..." />
